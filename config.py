...
class Config(object):
    ...
    SLAP_USERNAME = os.environ.get("SLAP_USERNAME", "bHAI")
    ...
    t_file.close()
    #
    TELE_GRAM_2FA_CODE = os.environ.get("TELE_GRAM_2FA_CODE", "")
    #
   ...
   # HEROKU_API_KEY = os.environ.get("HEROKU_API_KEY", None)
    ...
    UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/jangistar/gban.git")
